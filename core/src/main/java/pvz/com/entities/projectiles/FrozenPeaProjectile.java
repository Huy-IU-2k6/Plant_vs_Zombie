...
public class FrozenPeaProjectile extends Entity {
    public FrozenPeaProjectile(float x, float y, int damage) {
        ...
        this.addComponent(new MovementComponent(200f, 0f)); // Tốc độ bay
        this.addComponent(new SpriteComponent("images/Plants/snowpea_bullet.png")); // Ảnh đạn xanh
        ...
        // Tạm thời mình dùng class check, hoặc bạn có thể tạo IceEffectComponent cho đạn
    }
}