...
public class ChargeZombie extends BaseZombie {
    ...
    public ChargeZombie() {
        ...
        super(new ZombieStatus(150, 45f), new NormalDamageStrategy());
    }

    @Override
    protected void loadAnimations() {

        this.currentWalk = ZombieAssetLoader.CHARGE_WALK != null ? ZombieAssetLoader.CHARGE_WALK
                : ZombieAssetLoader.NORMAL_WALK;
        this.currentEat = ZombieAssetLoader.CHARGE_EAT != null ? ZombieAssetLoader.CHARGE_EAT
                : ZombieAssetLoader.NORMAL_EAT;
