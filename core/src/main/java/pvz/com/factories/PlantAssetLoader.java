...
public class PlantAssetLoader {
    ...
    public static void loadAll() {
        ...
        POTATO_GROWING = load("images/characters/plants/potatomine_plant/normal_state/normal_state_", 29, 0.06f,
                Animation.PlayMode.NORMAL);
        POTATO_UNARMED = load("images/characters/plants/potatomine_plant/init_state/init_state_", 1, 0.06f,
                Animation.PlayMode.LOOP);
        POTATO_RISING = load("images/characters/plants/potatomine_plant/grow_state/grow_state_", 25, 0.06f,
                Animation.PlayMode.NORMAL);
        POTATO_IDLE = load("images/characters/plants/potatomine_plant/idle_state/idle_state_", 30, 0.06f,
                Animation.PlayMode.LOOP);
        POTATO_EXPLODE = load("images/characters/plants/potatomine_plant/explode_state/explode_state_", 26, 0.06f,
                Animation.PlayMode.NORMAL);
        ...
        CHERRY_IDLE = load("images/characters/plants/cherrybomb_plant/normal_state/normal_state_", 6,
                PLANT_FRAME_DURATION,
                Animation.PlayMode.LOOP);
        CHERRY_EXPLODE = load("images/characters/plants/cherrybomb_plant/powie_state/powie_state_", 28, 18, 0.1f,
                Animation.PlayMode.NORMAL);
